...
export default function CoverSection({
  ...
  const positionClasses = isEditor
    ...
    : isStandaloneInvitation
      ? "absolute inset-0 h-full w-full pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]"
      : "absolute inset-0 h-full w-full"; // Phone mockup: fill the frame screen
